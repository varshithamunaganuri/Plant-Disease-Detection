...
def predict_disease(image_file, model, all_labels, target_language):
    try:
        ...
        if predicted_label == 'Potato Late blight':
            pesticide_info = """
                <h2><center><b>Potato Late blight</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                
                <ul style="font-size:17px;margin-left:40px;">
                    <li>1. Metalaxyl (Ridomil)</li>
            ...
            """
        elif predicted_label == 'Potato Early blight':
            pesticide_info = """
                <h2><center><b>Potato Early blight</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
        ...
        elif predicted_label == 'Potato Healthy':
            pesticide_info = """<h2><center><b>Potato Healthy</b></center></h2>
