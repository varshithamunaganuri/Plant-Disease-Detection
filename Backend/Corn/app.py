...
def predict_disease(image_file, model, all_labels, target_language):
    try:
        ...
        if predicted_label == 'Corn Northern Leaf Blight':
            pesticide_info = """
                <h2><center><b>Corn Northern Leaf Blight</b></center></h2>
            ...
            pesticide_info = """<h2><center><b>Corn Gray leaf spot</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                <ul style="font-size:17px;margin-left:40px;">
            ...
            pesticide_info = """<h2><center><b>Corn Common Rust</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                <ul style="font-size:17px;margin-left:40px;">
                    <li>1. Copper oxychloride (Kocide)</li>
                    <li>2. Mancozeb(Dithane)</li>
        ...
        elif predicted_label == 'Corn Healthy':
            pesticide_info = """<h2><center><b>Corn Healthy</b></center></h2>
