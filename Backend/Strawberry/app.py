...
def predict_disease(image_file, model, all_labels, target_language):
    try:
        ...
        if predicted_label == 'Strawberry Leaf scorch':
            pesticide_info = """
                <h2><center><b>Strawberry Leaf scorch</b></center></h2>
        ...
        elif predicted_label == 'Strawberry Healthy':
            pesticide_info = """<h2><center><b>Strawberry Healthy</b></center></h2>
...
gr_interface = gr.Interface(
    ...
    title="Strawberry Disease Predictor",
