...
def predict_disease(image_file, model, all_labels, target_language):
    try:
        ...
        if predicted_label == 'Brown Spot':
            pesticide_info = """
                <h2><center><b>Brown Spot</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                
                <ul style="font-size:17px;margin-left:40px;">
                    <li>1. Difenoconazole</li>
                    <li>2. Tebuconazole</li>
            ...
            """
        elif predicted_label == 'Blast':
            pesticide_info = """
                <h2><center><b>Blast</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                
                <ul style="font-size:17px;margin-left:40px;">
                    <li>1. Tebuconazole</li>
                    <li>2. Hexaconazole</li>
                    <li>3. Propiconazole</li>
                    <li>4. Azoxystrobin (Heritage)</li>
                    <li>5. Pyraclostrobin (Cabrio)</li>
                </ul><br>
            ...
            pesticide_info = """
                <h2><center><b>Bacterial Leaf Blight</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                
                <ul style="font-size:17px;margin-left:40px;">
                    <li>1. Copper oxychloride</li>
                    <li>2. Streptomycin</li>
                    <li>3. Oxytetracycline</li>
                    <li>4. Bacillus subtilis</li>
                    <li>5. Trichoderma species</li>
                </ul><br>
                <center><p class="note" style="font-size:15px;"><b>* * * IMPORTANT NOTE * * *</b></p></center><br>
                <center><p style="font-size:13px;">Be sure to follow local regulations and guidelines for application</p></center>
            """
