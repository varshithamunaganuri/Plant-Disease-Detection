...
def predict_disease(image_file, model, all_labels, target_language):
    try:
        ...
        if predicted_label == 'Bell pepper Bacterial Spot':
            pesticide_info = """
                <h2><center><b>Bell pepper Bacterial Spot</b></center></h2>
        ...
        elif predicted_label == 'Bell pepper Healthy':
            pesticide_info = """<h2><center><b>Bell pepper Healthy</b></center></h2>
