...
def predict_disease(image_file, model, all_labels, target_language):
    try:
        ...
        if predicted_label == 'Grape Isariopsis leaf Spot':
            pesticide_info = """
                <h2><center><b>Grape Isariopsis leaf Spot</b></center></h2>
            ...
            """
        elif predicted_label == 'Grape Black Rot':
            pesticide_info = """<h2><center><b>Grape Black Rot</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                <ul style="font-size:17px;margin-left:40px;">
                ...
                <center><p style="font-size:13px;">Be sure to follow local regulations and guidelines for application</p></center>
            """
        elif predicted_label == 'Grape Black Measles':
            pesticide_info = """<h2><center><b>Grape Black Measles</b></center></h2>
                <h4>PESTICIDES TO BE USED:</h4><br>
                <ul style="font-size:17px;margin-left:40px;">
                    <li>1. Copper oxychloride (Kocide)</li>
                    <li>2. Mancozeb(Dithane)</li>
        ...
        elif predicted_label == 'Grape Healthy':
            pesticide_info = """<h2><center><b>Grape Healthy</b></center></h2>
