...
• Displays disease name and preventive suggestions
...
Dataset: The dataset used for training is collected from publicly available plant disease image datasets found on open platforms such as Kaggle and similar open-source datasets. Images include multiple plant species with healthy and diseased leaf categories.

Future Improvements: • Show disease name and prevention details in multiple languages
...
Contributing: Contributions, suggestions and improvements are welcome. If you would like to contribute, feel free to fork this repository and submit a pull request with your changes.
